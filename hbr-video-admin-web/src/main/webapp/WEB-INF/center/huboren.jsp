...
.desc {
	...
	<h1 class="page-title"> 都有你小程序后台管理系统 </h1>
	        ...
	        <div class="portlet light portlet-fit bordered">
	            <div class="portlet-title">
	                <div class="caption">
	                    ...
	                    <span class="caption-subject bold font-dark uppercase">都有你小程序平台技术简介</span>
	    ...
	    <div class="col-lg-6 col-xs-12 col-sm-12">
	        <div class="portlet light portlet-fit bordered">
	            <div class="portlet-title">
	                <div class="caption">
	                    <i class="icon-microphone font-dark hide"></i>
	                    <span class="caption-subject bold font-dark uppercase"> 都有你短视频</span>
	                    <span class="caption-helper">短视频小程序书籍推荐</span>
	                </div>
	            </div>
	            <div class="portlet-body ">
	            	<div class="row ">
	                    <div class="col-md-4 ">
	                        <img src="<%=request.getContextPath() %>/static/pages/img/1.jpg" width="233px" height="233px"class="img-responsive"/>
	                    </div>
	                    <div class="col-md-8 " >
	                    	<h4><font color="blue">《redis深度历险》</font></h4>
	                    </div>
	                </div>
	                <div class="row " style="margin-top: 10px;">
	                    <div class="col-md-4 ">
	                        <img src="<%=request.getContextPath() %>/static/pages/img/2.jpg" width="233px" class="img-responsive"/>
	                    </div>
	                    <div class="col-md-8 " >
	                    	<h4><font color="blue">《SSM框架从零学起》</font></h4>
	                    </div>
	                </div>
	                <div class="row " style="margin-top: 10px;">
	                    <div class="col-md-4 ">
	                        <img src="<%=request.getContextPath() %>/static/pages/img/4.jpg" width="233px" class="img-responsive"/>
	                    </div>
	                    <div class="col-md-8 " >
	                    	<h4><font color="blue">《深入理解MariaDB和Mysql》</font></h4>
	                    </div>
	                </div>
	            </div>
	        </div>
